  ...
  return (
    <>
      <div className="home-page">
        <Helmet>
          <title>
            DeJure Advocates & Legal Consultants | Business Law & Consulting
          </title>
          <meta
            name="description"
            content="DeJure Advocates & Legal Consultants delivers corporate, tax, and regulatory counsel for businesses operating across Pakistan. Discover our mission, expertise, and client-first values."
          />
        </Helmet>
        {/* HERO=========== */}
          ...
          <div className="row">
            <div className="col-lg-7">
              <div className="card-body">
                ...
                <div className="text-separator fw-normal">
                  <p>
                    DeJure Advocates & Legal Consultants was founded to deliver
                    efficient, client-centric legal solutions for businesses navigating Pakistan's regulatory
                    landscape. We balance timely advice with strategic execution,
                    supporting decision-makers through complex transactions and
                    disputes.
                  </p>
                  <p>
                    Our lawyers collaborate across disciplines, pairing industry insight with rigorous legal
                ...
                <div className="services-content container mt-3">
                  ...
                  <div className="row mt-3 gx-3 flex-column flex-md-row ">
                    <div className="col-md-6">
                      ...
                      <p className="pt-4 px-2" style={{textAlign: 'justify'}}>
          ...
          <div className="row">
            <div className="col-lg-7">
              <div className="card-body">
                ...
                <div className="text-separator fw-normal">
                  <p>
                    DeJure Advocates & Legal Consultants delivers legal and
        ...
        <section className="recommendation p-3 bg-image m-3 px-0">
          <h6 className="guide-text ">WHY DEJURE ADVOCATES & LEGAL CONSULTANTS</h6>
          ...
          <div className="row mt-4 align-items-center mb-3">
            <div className="col-md-7 order-md-2">
              <div className="why-choose">
                <p className="why-choose-text" style={{textAlign: 'justify'}}>
